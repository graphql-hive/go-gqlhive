...
func (ec *executionContext) field_Query_todos_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_todos_argsCondition(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["condition"] = arg0
	arg1, err := ec.field_Query_todos_argsSortBy(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["sortBy"] = arg1
...
func (ec *executionContext) field_Query_todos_argsCondition(
	ctx context.Context,
	rawArgs map[string]any,
) (*model.TodosCondition, error) {
	if _, ok := rawArgs["condition"]; !ok {
...
func (ec *executionContext) field_Query_todos_argsSortBy(
	ctx context.Context,
	rawArgs map[string]any,
) (*model.TodosSortBy, error) {
...
func (ec *executionContext) unmarshalInputTodosCondition(ctx context.Context, obj any) (model.TodosCondition, error) {
...
func (ec *executionContext) unmarshalInputTodosConditionUser(ctx context.Context, obj any) (model.TodosConditionUser, error) {
